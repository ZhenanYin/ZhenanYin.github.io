...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/happy-paws/";
          },
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-came-back-to-the-u-s-after-6-years-sparkles-smile",
          title: 'Came back to the U.S. after 6 years! :sparkles: :smile:',
          description: "",
          section: "News",},{id: "news-started-my-phd-in-health-and-biomedical-informatics-at-indiana-university-indianapolis-mortar-board-tada",
          title: 'Started my PhD in Health and Biomedical Informatics at Indiana University Indianapolis! :mortar_board:...',
          description: "",
          section: "News",},{id: "projects-triton-town-autonomous-vehicles",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/Triton_Town_vehicle/";
            },},{id: "projects-crossseizure-learning-generalizable-representations-for-cross-dataset-epileptic-seizure-classification",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/crossseizure/";
            },},{id: "projects-embeddings-are-noise-eliminators-ablation-studies-to-show-what-is-eliminated-in-foundation-models",
          title: 'Embeddings are Noise Eliminators: Ablation Studies to Show What is Eliminated in Foundation...',
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/embedding/";
            },},{id: "projects-the-connection-between-mycobacterium-tuberculosis-and-macrophage-cells-in-lung-cancer-progression",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/macropage/";
            },},{id: "projects-deep-learning-for-plankton-image-retrieval",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/plankton/";
            },},{id: "projects-conformal-ultrasonic-device-for-non-invasive-central-blood-pressure-monitoring",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/ultrasonic/";
            },},{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%79%69%6E%31%30@%69%75.%65%64%75", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/ZhenanYin", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/zhenan-david-yin-a0358a136", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=O9mN2twAAAAJ", "_blank");
        },
      },{
